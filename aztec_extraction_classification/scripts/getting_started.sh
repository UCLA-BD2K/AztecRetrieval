...
python $PWD/../slots-extraction/aztec_extraction_classification/scripts/parse_extracts.py $PWD/../slots-extraction/data/$1/XMLExtracts/ $PWD/../slots-extraction/data/$1/textExtracts/ None $PWD/../slots-extraction/data/$1/slotExtracts/slot_extracts.json $2
