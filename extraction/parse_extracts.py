...
# Set correctDOI records argument required to False, not required right now
# This script requires nltk along with some nltk data download
...
def main():
    ...
    parser.add_argument('-correctDOIRecords', help = 'JSON file containing tool records with correct Publication DOI.', type = str, required = False)
