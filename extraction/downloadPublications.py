...
# Class is used to fetch names from dois for pdf title


class UpdateName(Thread):
...
def extract_url(doc):
    try:
        ...
        print e
        print "Manual extraction of url failed with " + doc.doi
        doc.url = None
...
def main(filename, directory=None):
    ...
    update_name()   # Fetch names of all the documents using their doi
