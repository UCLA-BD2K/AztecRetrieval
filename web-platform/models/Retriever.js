...
// MySQL models
var Domain = require("./mysql/domain");
var Institution = require("./mysql/institution");
var Platform = require("./mysql/platform");
var Language = require("./mysql/language");
var License = require("./mysql/license");
var Resource = require("./mysql/resource");
var ResourceMap = require("./mysql/resource_map");
var Tag = require("./mysql/tag");
var User = require("./mysql/user");
var Tool = require("./mysql/tool");

// Mongo models
var M_tool = require('./mongo/tool');
var M_author = require('./mongo/author');
var M_link = require('./mongo/link');
var M_maintainer = require('./mongo/maintainer');
var M_version = require('./mongo/version');
 ...
 */
Retriever.prototype._latest = function(self) {
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        if (latest_file == null) {
            ...
            var latest_time = fs.statSync(latest_file).mtime.getTime();
